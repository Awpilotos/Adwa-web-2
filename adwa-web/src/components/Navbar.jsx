...
export default function Navbar(){
    ...
    return (<div className='w-full sticky top-[33px] h-[90px] flex z-90 items-center justify-center'>
        <header className="absolute left-[10%]">
            <a href="/">
                <img
                        ...
                        <div className="flex items-center space-x-2 group cursor-pointer ">
                            ...
                            <div className="items-center gap-2"> 
                                {navigationItems.map((item, index) => (
                                    <button key={index} onClick={() => setActiveIndex(index)} className={`inline-flex items-center justify-center gap-2.5 px-4 py-2 rounded-2xl font-nunito font-normal text-white text-base
                                        ${activeIndex === index
